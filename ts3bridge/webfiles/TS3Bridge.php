...
{
    case "json":
        $links = json_decode(file_get_contents("links/links.json") , true);
    break;
...
switch ($action)
{
    case "connect":
        ...
        {
            if (strpos($ex->getMessage() , "invalid client") !== false) die("Du bist nicht auf unserem TeamSpeak-Server verbunden.\nIP: mightful-noobs.de");
        }
        die("OK");
        break;
